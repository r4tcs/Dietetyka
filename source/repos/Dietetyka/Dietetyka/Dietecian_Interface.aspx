            ...
            <ul class="navbar-nav ml-auto ml-md-0">
                <li class="nav-item dropdown no-arrow mx-1" runat="server">
                    <a class="nav-link">
                        ...
                        <asp:Button ID="ButtonAddProduct" runat="server" Text="Dodaj Produkt" OnClick="ButtonAddProduct_Click" BackColor="#333333" BorderColor="#333333" BorderStyle="None" ForeColor="Gray" />
                        <span></span></a>
                ...
                <li class="nav-item dropdown no-arrow mx-1" runat="server">
                    <a class="nav-link">
                        ...
                        <asp:Button ID="ButtonProductList" runat="server" Text="Lista produktów" OnClick="ButtonProductList_Click" BackColor="#333333" BorderColor="#333333" BorderStyle="None" ForeColor="Gray" />
                        <span></span></a>
                </li>
                <li class="nav-item dropdown no-arrow mx-1" runat="server">
                    <a class="nav-link">
                        <i class="fas fa-fw fa-clipboard-check"></i>
                        <asp:Button ID="ButtonCreateDish" runat="server" Text="Stwórz danie" OnClick="ButtonCreateDish_Click" BackColor="#333333" BorderColor="#333333" BorderStyle="None" ForeColor="Gray" />
                        <span></span></a>
                </li>
                <li class="nav-item dropdown no-arrow mx-1" runat="server">
                    <a class="nav-link">
                        <i class="fas fa-fw fa-clipboard-list"></i>
                        <asp:Button ID="ButtonDishList" runat="server" Text="Lista dań" OnClick="ButtonDishList_Click" BackColor="#333333" BorderColor="#333333" BorderStyle="None" ForeColor="Gray" />
                        <span></span></a>
                </li>
                <li class="nav-item dropdown no-arrow mx-1" runat="server">
                    <a class="nav-link">
                        <i class="fas fa-fw fa-clipboard-check"></i>
                        <asp:Button ID="ButtonCreateMenu" runat="server" Text="Utwórz menu" OnClick="ButtonCreateMenu_Click" BackColor="#333333" BorderColor="#333333" BorderStyle="None" ForeColor="Gray" />
                        <span></span></a>
                </li>
                <li class="nav-item dropdown no-arrow mx-1" runat="server">
                    <a class="nav-link">
                        <i class="fas fa-user-circle fa-fw"></i>
                        <asp:Button ID="ButtonLogout" runat="server" Text="Wyloguj" OnClick="ButtonLogout_Click" BackColor="#333333" BorderColor="#333333" BorderStyle="None" ForeColor="Gray" />
                        <span></span></a>
                </li>
            </ul>
